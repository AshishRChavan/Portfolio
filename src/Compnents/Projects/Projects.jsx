        ...
        <div className="projectcontainer">
          <div className="projectcontent">
            ...
            <div className="project-grid-one">
              <img className="project-img" src="../../../assets/RoverAppImg.webp" width="571px" height="auto"></img>
            ...
            <div className="project-grid-two">
              ...
              <img className="project-img" src="../../../assets/NewsAppImg.webp" width="571px" height="auto"></img>
            </div>
          </div>
        </div>
      </section>
